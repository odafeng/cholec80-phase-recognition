...
Holm) --- precisely the axis on which the principled QCD detector is needed. The
frontier-dominance comparison is reported as point estimates across the twelve cells;
per-video CIs for the QCD operating points require re-running the decoders with cached
posteriors (in progress).
