...
and the QCD dominance replicates under per-video CIs---milder in absolute terms, as
transitions are sharper---confirming generality while showing the benefit's magnitude is
procedure dependent. We report negative and nuanced results faithfully. Code and configurations are
released.
\end{abstract}
